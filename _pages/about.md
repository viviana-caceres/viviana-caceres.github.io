...
Hi! I'm Viviana, a third-year Ph.D. student and NSF Graduate Research Fellow at Penn State.

My research focuses on testing general relativity and modeling gravitational waveforms. I work with B.S. Sathyaprakash in the [Physics and Astrophysics to the eXtreme (PAX) group](https://sites.psu.edu/infinity/) at Penn State. I'm also a member of the [LIGO Scientific Collaboration](https://ligo.org/) and the [Cosmic Explorer Consortium](https://cosmicexplorer.org/index.html#intro).
...
Beyond research, I'm passionate about physics outreach and scientific writing. I'm an author for [Astrobites](https://astrobites.org/author/vcaceres/) and I have volunteered in many public physics demonstrations. This website is a space to compile helpful resources, share my work, and spread my love for physics!
...
Me interesa poner a prueba la teoría de relatividad general y modelar las señales de ondas gravitacionales. Trabajo bajo la supervisión de B.S. Sathyaprakash en el grupo de [Física y Astrofísica al Extremo (PAX, por sus siglas en inglés)](https://sites.psu.edu/infinity/). También soy miembro de la [colaboración científica de LIGO](https://ligo.org/) y el [consorcio Cosmic Explorer](https://cosmicexplorer.org/index.html#intro).
